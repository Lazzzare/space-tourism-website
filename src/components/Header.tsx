  ...
  return (
    <header className="flex justify-between items-center">
      ...
      {mobile ? (
       ...
       md:bg-[#151823] lg:bg-transparent
       pt-5 gap-[65px] flex items-center
       flex-col md:static  md:h-auto md:px-12 md:pt-0 z-10"
        >
        ...
        <nav
          className="absolute
            h-full top-0 bottom-0
            right-0
            backdrop-blur-[40.774227142333984px] hidden
            md:bg-[#151823] lg:bg-transparent
            pt-5 gap-[65px] items-center
            flex-col md:static md:flex md:h-auto md:px-12 md:pt-0 z-10"
        >
          <motion.div
            initial={{ opacity: 0, x: 500 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 1.5 }}
          >
            <ul className="text-white  flex-col gap-8 hidden md:flex md:flex-row md:gap-9 pt-32 md:pt-0">
              <li className="pl-8 md:pl-0">
                <NavLink
                  to="/"
                  state="home"
